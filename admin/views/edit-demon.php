  ...
  <div class="max-w-7xl mx-auto relative z-10">
    ...
    <div class="grid gap-10 xl:gap-16 md:grid-cols-2 items-start">
          ...
          <div class="p-6 xl:p-7">
            <?php if (!empty($demon->image_file_id)): ?>
              <div class="mb-6" id="currentImagePreview">
                ...
                <img src="/?file_id=<?= $demon->image_file_id ?>" alt="Current" class="w-full h-48 object-cover rounded-lg border border-amber-600/30" />
              </div>
            <?php endif; ?>
      ...
      <section class="md:col-span-1">
        <form action="/admin/actions/edit-demon" method="post" enctype="multipart/form-data" class="bg-black/70 border border-amber-600/30 rounded-xl overflow-hidden" id="editDemonForm">
